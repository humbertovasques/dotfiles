...
keymap("", "s", "<Nop>", opts)
keymap("", "sq", "/-<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sw", "/[<CR><cmd>nohlsearch<CR>", opts)
keymap("", "se", "/]<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sr", "/=<CR><cmd>nohlsearch<CR>", opts)
-- keymap("", "st", "/\\~<CR><cmd>nohlsearch<CR>", opts)
keymap("", "su", "/+<CR><cmd>nohlsearch<CR>", opts)
keymap("", "si", "/{<CR><cmd>nohlsearch<CR>", opts)
keymap("", "so", "/}<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sp", "/_<CR><cmd>nohlsearch<CR>", opts)

keymap("", "sa", "/!<CR><cmd>nohlsearch<CR>", opts)
keymap("", "ss", "/@<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sd", "/#<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sf", "/\\$<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sg", "/`<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sh", "/&<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sj", "/*<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sk", "/(<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sl", "/)<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s;", "/:<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s'", "/'<CR><cmd>nohlsearch<CR>", opts)

keymap("", "sz", "/\\<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sx", "/|<CR><cmd>nohlsearch<CR>", opts)
-- keymap("", "sc", "/\"<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sc", "/\\~<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sv", "/%<CR><cmd>nohlsearch<CR>", opts)
keymap("", "sm", "/\\^<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s,", "/<<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s.", "/><CR><cmd>nohlsearch<CR>", opts)
keymap("", "s/", "/?<CR><cmd>nohlsearch<CR>", opts)

keymap("", "s<leader>q", "?-<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>w", "?[<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>e", "?]<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>r", "?=<CR><cmd>nohlsearch<CR>", opts)
-- keymap("", "s<leader>t", "?\\~<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>u", "?+<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>i", "?{<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>o", "?}<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>p", "?_<CR><cmd>nohlsearch<CR>", opts)

keymap("", "s<leader>a", "?!<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>s", "?@<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>d", "?#<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>f", "?\\$<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>g", "?`<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>h", "?&<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>j", "?*<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>k", "?(<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>l", "?)<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>;", "?:<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>'", "?'<CR><cmd>nohlsearch<CR>", opts)

keymap("", "s<leader>z", "?\\<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>x", "?|<CR><cmd>nohlsearch<CR>", opts)
-- keymap("", "s<leader>c", "?\"<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>c", "?\\~<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>v", "?%<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>m", "?\\^<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>,", "?<<CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>.", "?><CR><cmd>nohlsearch<CR>", opts)
keymap("", "s<leader>/", "??<CR><cmd>nohlsearch<CR>", opts)
...
keymap("n", "<leader>dn", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
